...
export const Header: React.FC<Props> = ({ project, views }) => {
  ...
  return (
    <header
      ref={ref}
      className="via-ddDarkGreen-900 relative isolate overflow-hidden bg-gradient-to-tl from-black to-black"
    >
      <div
          ...
          <div className="flex justify-between gap-8">
            <span
              ...
              className={`flex items-center gap-1 duration-200 hover:font-medium ${
                isIntersecting
                  ? ' text-ddLightGreen-400 hover:text-ddLightGreen-100'
      ...
      <div className="container relative isolate mx-auto overflow-hidden  py-24 sm:py-32">
        <div className="mx-auto flex max-w-7xl flex-col items-center px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="text-ddLightGreen-300 mt-6 text-lg leading-8">{project.description}</p>
          </div>
